...
%--------------------------------------------------------------------------------------------------------------
\newcommand{\Kategorie}{Seminararbeit}
\newcommand{\Titel}{Titel des Themas}
\newcommand{\Verfasser}{Name des Verfassers}
\newcommand{\Geburtstag}{Geburtstag}
\newcommand{\Geburtsort}{Geburtsort}
\newcommand{\Betreuer}{Jane Doe}
\newcommand{\ZweitBetreuer}{John Doe}
...
%--------------------------------------------------------------------------------------------------------------
\bibliographystyle{alpha}	% Stil des Literaturverzeichnisses (hier nach DIN 1505)

%--------------------------------------------------------------------------------------------------------------
% Darstellung des Glossars und des Abkürzungsverzeichnisses einstellen
%--------------------------------------------------------------------------------------------------------------
\usepackage[nomain,style=list,nonumberlist,acronym,toc]{glossaries}
